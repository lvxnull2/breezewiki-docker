...
(module+ test
  ...
  (test-section 'bugs-from-cadence
    ...
    (test 'figcaption-as-parent-of-p
          (html->xexp "<figcaption> <p class=\"caption\">words</p><img src=\"nowhere\"></figcaption>")
          '(*TOP* (figcaption " "
                              (p (@ (class "caption")) "words")
                              (img (@ (src "nowhere"))))))

    (test 'attribute-html-entities-1
          (html->xexp "<img src=\"https://example.com/images?src=Blah.jpg&amp;width=150\">")
          '(*TOP* (img (@ (src "https://example.com/images?src=Blah.jpg&width=150")))))

    (test 'attribute-html-entities-2
          (html->xexp "<a href=\"https://example.com/phpbb/viewtopic.php?f=31&amp;t=1125\">https://example.com/phpbb/viewtopic.php?f=31&amp;t=1125</a>")
